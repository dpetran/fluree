(ns fluree.ledger-api.ledger.docs.examples.supply-chain
...
(deftest add-schema
  (testing "Add schema for the supply chain app"
    (let [txn         (edn/read-string (slurp (io/resource "SupplyChain/schema.edn")))
...
(deftest add-sample-data
  (testing "Add sample data for the supply chain app"
    (let [txn       (edn/read-string (slurp (io/resource "SupplyChain/data.edn")))
...
(deftest add-block-4-smart-functions
  (testing "Add sample data for the supply chain app"
    (let [txn       (edn/read-string (slurp (io/resource "SupplyChain/smartFunctionBlock4.edn")))
          data-resp (async/<!! (fdb/transact-async (basic/get-conn) test/ledger-supplychain txn))]
...
(deftest add-block-5-smart-functions
  (testing "Add sample data for the supply chain app"
    (let [txn       (edn/read-string (slurp (io/resource "SupplyChain/smartFunctionBlock5.edn")))
          data-resp (async/<!! (fdb/transact-async (basic/get-conn) test/ledger-supplychain txn))]
...
(deftest add-block-6-smart-functions
  (testing "Add sample data for the supply chain app"
    (let [txn       (edn/read-string (slurp (io/resource "SupplyChain/smartFunctionBlock6.edn")))
          data-resp (async/<!! (fdb/transact-async (basic/get-conn) test/ledger-supplychain txn))]
...
(deftest add-block-7-smart-functions
  (testing "Add sample data for the supply chain app"
    (let [txn       (edn/read-string (slurp (io/resource "SupplyChain/smartFunctionBlock7.edn")))
          data-resp (async/<!! (fdb/transact-async (basic/get-conn) test/ledger-supplychain txn))]
