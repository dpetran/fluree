...
(defn build-env
  ...
  (let [properties        (when-let [prop-file (:fdb-properties-file environment)]
        ...
        prop-env-flag     (merge properties java-prop-flags environment {:fdb-api-port 8090
                                                                         :fdb-mode "ledger"
...
(comment
  (build-env {})
  {:fdb-group-snapshot-path "data/group/snapshots", :fdb-storage-s3-group-prefix "group/", :fdb-pw-auth-jwt-secret nil, :fdb-ledger-private-keys nil, :fdb-group-catch-up-rounds 10, :fdb-pw-auth-enable true, :fdb-group-private-key nil, :fdb-api-port 8090, :fdb-join? false, :fdb-query-peer-servers "localhost:8090", :fdb-json-bigdec-string true, :fdb-storage-file-ledger-path "ledger/", :fdb-group-this-server nil, :fdb-mode "ledger", :fdb-group-timeout 2000, :fdb-stats-report-frequency "1m", :fdb-pw-auth-signing-key nil, :fdb-api-open true, :fdb-storage-s3-ledger-prefix "ledger/", :fdb-group-private-key-file nil, :fdb-consensus-type "raft", :fdb-storage-type "file", :fdb-pw-auth-secret "fluree", :fdb-storage-file-directory nil, :fdb-group-snapshot-threshold 200, :fdb-memory-reindex-max "2mb", :fdb-group-port nil, :fdb-group-heartbeat nil, :fdb-storage-file-group-path "group/", :fdb-storage-file-root "./data/", :fdb-pw-auth-jwt-max-exp "1y", :fdb-ledger-servers nil, :fdb-encryption-secret nil, :fdb-license-key nil, :fdb-group-log-history 5, :fdb-memory-reindex "1mb", :fdb-group-log-directory "./data/group", :fdb-pw-auth-jwt-max-renewal "1y", :fdb-memory-cache "200mb", :fdb-group-config-path "./", :fdb-storage-s3-bucket nil, :fdb-group-servers nil}
